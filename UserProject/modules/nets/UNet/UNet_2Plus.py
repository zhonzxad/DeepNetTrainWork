...
from UserProject.modules.nets.UNet.unet_init_weights import init_weight
from UserProject.modules.nets.UNet.UNet_layers import UNetConv2, UNetUp, unetUp_origin


class UNet_2Plus(nn.Module):

    def __init__(self, in_channels=3, n_classes=2, feature_scale=4, 
                    is_deconv=True, is_batchnorm=True, is_ds=False):
    ...
    def forward(self, inputs):
        ...
        if self.is_ds:
            ...
            return final#F.sigmoid(final_4)
