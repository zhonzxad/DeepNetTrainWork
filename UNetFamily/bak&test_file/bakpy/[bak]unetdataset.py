...
class UNetDataset(Dataset):
    def __init__(self, imgpath, labelpath, image_size, num_classes, random_data=False):
        super(UNetDataset, self).__init__()

        self.imgpath = imgpath
        self.imgpath_list = os.listdir(self.imgpath)
    ...
    def __getitem__(self, index):
        ...
        # 从文件中读取图像
        jpg = Image.open(self.imgpath   + r"\\" +self.imgpath_list[index])
        png = Image.open(self.labelpath + r"\\" +self.labelpath_list[index])
